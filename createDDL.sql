...
CREATE TABLE USUARIO (ID BIGINT NOT NULL, DTYPE VARCHAR(31), CONTRASENA VARCHAR(255), CORREO VARCHAR(255), ROL INTEGER, USUARIO VARCHAR(255), UNIVERSIDAD_ID_UNIVERSIDAD BIGINT, PRIMARY KEY (ID))
