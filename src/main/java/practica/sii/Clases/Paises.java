...
public enum Paises
{
    ...
    private static final Map<String, Paises> alpha3Map = new HashMap<String, Paises>();
    private static final Map<Integer, Paises> numericMap = new HashMap<Integer, Paises>();


    static
    {
        for (Paises cc : values())
        {
    ...
    private Paises(String name, String alpha3, int numeric)
    {
        this.name = name;
        this.alpha3 = alpha3;
     ...
     */
    public static Paises getByCode(String code)
    {
        if (code == null)
        {
            return null;
    ...
    private static Paises getByAlpha2Code(String code)
    {
        try
        {
            return Enum.valueOf(Paises.class, code);
        }
    ...
    private static Paises getByAlpha3Code(String code)
    {
     ...
     *         A CountryCode instance, or null if not found.
     */
    public static Paises getByCode(int code)
    {
